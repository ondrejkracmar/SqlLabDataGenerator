...
This folder is also used to allow the user to easily create a custom function-specific configuration, for example in order to change the trigger settings.
